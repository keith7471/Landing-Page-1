...
export const HERO_CONTENT = {
  ...
  sky_img:'https://photo-cdn2.icons8.com/QylMjmByM9shM2D0Yc4fFTTAPjndxDPlTANzzeod9cA/rs:fit:666:1072/czM6Ly9pY29uczgu/bW9vc2UtcHJvZC5l/eHRlcm5hbC9hMmE0/Mi9jMDg1ODdkYjky/MGQ0NDg3OWU4YTQ3/YjE5OThlYjk0MS5q/cGc.jpg'
};

//FAQ
export const AI_FAQs = [
  {
    question: "What is this AI product used for?",
    answer: "This AI-powered solution automates tasks, enhances decision-making, and provides intelligent insights to improve efficiency and productivity."
  },
  {
    question: "How does the AI model work?",
    answer: "Our AI model uses advanced machine learning algorithms to analyze data, recognize patterns, and make real-time predictions or recommendations."
  },
  {
    question: "Is my data safe with this AI product?",
    answer: "Yes, we prioritize security and use end-to-end encryption, secure cloud storage, and compliance with industry standards to protect your data."
  },
  {
    question: "Can this AI product integrate with existing systems?",
    answer: "Absolutely! Our AI product offers seamless integration with various APIs and platforms, ensuring compatibility with your existing tech stack."
  },
  {
    question: "Does the AI product require training?",
    answer: "It depends on the use case. Some features work out of the box, while others may require fine-tuning with your data for optimal performance."
  },
  {
    question: "Is customer support available for troubleshooting?",
    answer: "Yes, we offer 24/7 customer support, detailed documentation, and AI-driven troubleshooting to assist with any issues."
  }
];
